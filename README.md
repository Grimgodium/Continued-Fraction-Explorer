...
The Golden Ratio $\phi$ is theoretically the "most irrational" number because its continued fraction consists entirely of ones: $[1; 1, 1, 1, \dots]$. This leads to the slowest possible convergence among irrational numbers. This project "stress-tests" this property against other constants like $\pi$.
